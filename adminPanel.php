...
<section id="topic-header">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center"><h1 style="color: brown">Notice : Upcoming Exam</h1></div>
            <br>
            <div class="col-md-3 hidden-phone"></div>
            <div class="col-md-6" id="form-login">
                <form class="well" action="" method="post" name="upcomingExamForm">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <button type="submit" id="submit" name="upcomingExamFormImport" class="btn btn-success btn-flat btn-lg pull-right button-loading" data-loading-text="Loading...">Confirm</button>
                            </div>
                        </div>
                    </fieldset>
                </form>
        ...
        <div class="row">
            <div class="col-md-12 text-center"><h1 style="color: brown">Upcoming Exam List</h1></div>
            <br>
            <?php
            if($rows1>0){
            ?>
            <table class="table table-bordered">
                ...
                while ($rowTS = mysqli_fetch_array($result1)) {
                    ...
                    <tr>
                        ...
                        <td><center><?php $summary = $rowTS['exam_date']; echo $summary;?></center></td>
                        <td ><a href="upcomingExamDelete.php?edit_id=<?php echo $rowTS['id']; ?>">Delete</a></td>
                    </tr>
        ...
        <div class="row">
            <div class="col-md-12 text-center"><h1 style="color: brown">Latest News</h1></div>
            <br>
            <div class="col-md-3 hidden-phone"></div>
            <div class="col-md-6" id="form-login">
                <form class="well" action="" method="post" name="upcomingExamForm">
                    <fieldset>
                        <div class="control-group">
                            ...
                            <div class="controls form-group">
                                <input type="text" name="notice" id="file" class="input-large form-control">
                            </div>
                        </div>

                        <legend>Latest Notice</legend>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <button type="submit" id="submit" name="noticeFormImport" class="btn btn-success btn-flat btn-lg pull-right button-loading" data-loading-text="Loading...">Confirm</button>
                            </div>
                        </div>
                    </fieldset>
                </form>
        ...
        <div class="row">
            <div class="col-md-12 text-center"><h1 style="color: brown">Notice List</h1></div>
            <br>
            <?php
            if($rowsNotice>0){
            ?>
            <table class="table table-bordered">
                ...
                while ($rowTS = mysqli_fetch_array($resultNotice)) {
                    ...
                    ?>
                    <tr>
                        <td><center><?php $summary = $rowTS['notice']; echo $summary;?></center></td>
                        <td ><a href="noticeDelete.php?edit_id=<?php echo $rowTS['id']; ?>">Delete</a></td>
                    </tr>
